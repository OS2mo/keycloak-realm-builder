...
locals {
  collection_permissions = {
    ...
    association     = ["read", "create", "update", "terminate", "delete", "refresh"]
    ...
    kle             = ["read", "create", "update", "terminate", "delete", "refresh"]
    leave           = ["read", "create", "update", "terminate", "delete", "refresh"]
    manager         = ["read", "create", "update", "terminate", "delete", "refresh"]
    org             = ["read", "create"]
    org_unit        = ["read", "create", "update", "terminate", "delete", "refresh"]
    owner           = ["read", "create", "update", "terminate", "delete", "refresh"]
    registration    = ["read"]
